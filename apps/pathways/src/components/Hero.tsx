  ...
  return (
    <Box
      sx={{
        ...
        position: 'relative',
        background:
          'linear-gradient(135deg, rgba(74, 144, 226, 0.1) 0%, rgba(80, 39, 176, 0.1) 100%)',
        overflow: 'hidden',
        padding: { xs: 2, md: 4 },
      }}
    >
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            Transform your ideas into beautiful React components with the power of AI. Generate,
            customize, and save stunning UI elements in seconds.
          </Typography>
