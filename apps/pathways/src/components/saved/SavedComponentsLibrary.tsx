...
export default function SavedComponentsLibrary() {
  ...
  const filterComponents = () => {
    ...
    const filtered = savedComponents.filter(
      (component) =>
                  ...
                  >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      ...
                      <IconButton
                        size="small"
                        onClick={(e) =>
                          setMenuAnchor({ ...menuAnchor, [component.id]: e.currentTarget })
                        }
                ...
                >
                  <MenuItem
                    onClick={() => {
                      ...
                      setMenuAnchor({ ...menuAnchor, [component.id]: null });
                    }}
                  >
                    <ListItemIcon>
                  ...
                  <MenuItem
                    onClick={() => {
                      handleDownload(component);
                      setMenuAnchor({ ...menuAnchor, [component.id]: null });
                    }}
                  >
                    <ListItemIcon>
                      <Download sx={{ color: 'rgba(255, 255, 255, 0.7)' }} />
                    </ListItemIcon>
      ...
      >
        ...
        <DialogContent>
          <TextField
            ...
            onChange={(e) =>
              setEditingComponent((prev) => (prev ? { ...prev, name: e.target.value } : null))
            }
            margin="normal"
            sx={{
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) =>
              setEditingComponent((prev) => (prev ? { ...prev, title: e.target.value } : null))
            }
            margin="normal"
            sx={{
              '& .MuiOutlinedInput-root': {
