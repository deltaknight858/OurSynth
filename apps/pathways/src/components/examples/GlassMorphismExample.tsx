  ...
  return (
    <Box
      sx={{
        padding: 4,
        background:
          'linear-gradient(135deg, rgba(74, 144, 226, 0.3) 0%, rgba(80, 39, 176, 0.3) 100%)',
        minHeight: '100vh',
        position: 'relative',
      }}
    >
      ...
      <div className="glass" style={{ padding: '2rem', marginBottom: '2rem', maxWidth: '400px' }}>
        ...
        <Button variant="contained" className="glass-button" sx={{ color: 'white' }}>
          Glass Button
        </Button>
      </div>
      ...
      <div
        ...
        style={{ padding: '1.5rem', marginBottom: '2rem', maxWidth: '400px' }}
      >
      ...
      <div
        ...
        style={{ padding: '2rem', marginBottom: '2rem', maxWidth: '400px' }}
      >
        <Typography variant="h6" sx={{ color: 'white', marginBottom: 1 }}>
          Dark Glass Variant
        </Typography>
      ...
      <Box sx={{ position: 'relative', width: '200px', height: '200px', marginTop: 4 }}>
        ...
        >
          ...
          {/* Animated Data Nodes */}
          <div className="data-node" style={{ top: '20px', left: '30px' }} />
          <div
            className="data-node"
            style={{ top: '50px', left: '80px', animationDelay: '0.5s' }}
          />
          <div className="data-node" style={{ top: '30px', left: '120px', animationDelay: '1s' }} />
          <div
            className="data-node"
            style={{ top: '70px', left: '150px', animationDelay: '1.5s' }}
          />
          <div className="data-node" style={{ top: '90px', left: '50px', animationDelay: '2s' }} />
        </Paper>
      </Box>
