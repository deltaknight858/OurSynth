                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    '&::before': {
                      ...
                      borderRadius: '12px',
                      background:
                        'linear-gradient(45deg, rgba(160, 32, 240, 0.2), rgba(0, 255, 0, 0.2))',
                      opacity: 0.7,
                      zIndex: -1,
                      filter: 'blur(8px)',
                    },
        ...
        {navigationLinks.map((link) => (
          <MenuItem
            ...
            sx={{
              padding: '16px 20px',
              color: isActiveLink(link.href) ? '#a020f0' : '#000000',
              backgroundColor: isActiveLink(link.href) ? 'rgba(160, 32, 240, 0.1)' : 'transparent',
              fontWeight: isActiveLink(link.href) ? 600 : 500,
              transition: 'all 0.3s ease',
              '&:hover': {
                backgroundColor: 'rgba(160, 32, 240, 0.15)',
          ...
          >
            <Box sx={{ mr: 2, display: 'flex', alignItems: 'center' }}>{link.icon}</Box>
            {link.label}
          </MenuItem>
        ))}
      </Menu>
