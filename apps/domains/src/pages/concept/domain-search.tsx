  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Search millions of available domains. Get instant availability results and secure your online presence today."
        />
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/8 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-3/4 left-1/2 w-64 h-64 bg-blue-500/6 rounded-full blur-3xl animate-pulse"
            ...
            <div className="w-full">
              <div className="mb-12">
                ...
                <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
                  Search millions of available domains. Get instant availability results and secure
