              ...
              <div className="flex-1 relative">
                <div
                  className={cn(
                    ...
                    query
                      ? "border-cyan-500/60 shadow-2xl shadow-cyan-500/25"
                      : "border-gray-600/40",
          ...
          {isLoading ? (
            ...
            <div className="animate-in slide-in-from-bottom-4 fade-in duration-500">
              <div className="mb-6 text-center">
                <h2 className="text-2xl font-bold text-white mb-2">Search Results for "{query}"</h2>
                <p className="text-gray-400">Found {suggestions.length} domain suggestions</p>
              </div>
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-white font-bold text-lg">{suggestion.domain}</span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <span className="text-white font-bold text-lg">{suggestion.price}</span>
                        <span
                          className={cn(
