      ...
      <div className="text-center space-y-6">
        <div className="p-6 rounded-xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-400/20">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <span className="font-medium text-cyan-400">{sentEmail}</span>
          </p>
        ...
        <div className="space-y-3">
          ...
          >
            {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Resend Magic Link"}
          </Button>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <p className="text-xs text-gray-400">No password required • Secure • One-click sign in</p>
      </div>
    </div>
  );
}
