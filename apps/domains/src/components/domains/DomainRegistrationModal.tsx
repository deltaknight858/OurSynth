            ...
            <div className="space-y-8">
              ...
              >
                ...
                <Select value={renewalPeriod} onValueChange={setRenewalPeriod}>
                  <SelectTrigger
                    className={`bg-slate-800/30 border-slate-600/50 text-white backdrop-blur-sm transition-all duration-300 ${
                  ...
                  <SelectContent className="bg-slate-800/95 backdrop-blur-xl border-slate-600/50">
                    <SelectItem value="1" className="text-white hover:bg-slate-700/50">
                      1 Year - $12.99
                    </SelectItem>
                    <SelectItem value="2" className="text-white hover:bg-slate-700/50">
                      2 Years - $25.98
                    </SelectItem>
                    <SelectItem value="3" className="text-white hover:bg-slate-700/50">
                      3 Years - $38.97
                    </SelectItem>
                    <SelectItem value="5" className="text-white hover:bg-slate-700/50">
                      5 Years - $64.95
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              >
                <div className="flex items-center space-x-3 p-4 rounded-xl bg-slate-800/20 border border-slate-600/30 backdrop-blur-sm transition-all duration-300 hover:border-purple-400/50 hover:shadow-lg hover:shadow-purple-500/20">
                  ...
                  <div className="flex-1">
                    <Label
                      htmlFor="whois-privacy"
                      className="text-white font-medium cursor-pointer flex items-center gap-2 drop-shadow-sm"
                    >
              ...
              <div className="bg-gradient-to-r from-slate-800/40 to-slate-700/40 backdrop-blur-sm rounded-xl p-6 border border-slate-600/30">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-slate-300 font-medium">
                    Domain Registration ({renewalPeriod} year{renewalPeriod !== "1" ? "s" : ""})
                  </span>
                  <span className="text-white font-semibold">
                    ${(12.99 * parseInt(renewalPeriod)).toFixed(2)}
                  </span>
                </div>
                {whoisPrivacy && (
                  <div className="flex justify-between items-center mb-4">
