...
const neonButtonBaseClasses =
  "bg-transparent rounded-full w-10 h-10 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900";
const neonButtonCyanClasses =
  "border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black shadow-md shadow-cyan-500/30 hover:shadow-lg hover:shadow-cyan-500/50 focus:ring-cyan-400";
const neonButtonRedClasses =
  "border border-red-500 text-red-500 hover:bg-red-500 hover:text-white shadow-md shadow-red-500/30 hover:shadow-lg hover:shadow-red-500/50 focus:ring-red-400";
