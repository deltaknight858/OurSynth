        ...
        <div className="container mx-auto px-4 py-16 max-w-6xl">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Lightning-fast deployments with zero configuration. Deploy your
              sites instantly and manage them with our powerful dashboard.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            ...
            <Card className="bg-black/20 backdrop-blur-lg border border-white/10 hover:border-cyan-500/30 transition-all duration-300 group">
              ...
              <CardContent>
                <p className="text-gray-400">
                  Your sites are served from our worldwide edge network for
                  maximum performance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black/20 backdrop-blur-lg border border-white/10 hover:border-cyan-500/30 transition-all duration-300 group">
              ...
              <CardContent>
                <p className="text-gray-400">
                  Built-in SSL, DDoS protection, and 99.9% uptime guarantee for
                  your peace of mind.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="text-center bg-black/20 backdrop-blur-lg border border-white/10 rounded-2xl p-12">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Join thousands of developers who trust Deploy for their web
              hosting needs.
            </p>
