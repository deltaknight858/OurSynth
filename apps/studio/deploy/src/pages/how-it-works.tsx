  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn how Deploy makes web hosting simple with our step-by-step guide"
        />
        ...
        <div className="container mx-auto px-4 py-16 max-w-6xl">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              From code to live site in minutes. Our platform simplifies web
              deployment so you can focus on building amazing experiences.
            </p>
          </div>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12">
                <div className="lg:w-1/2">
                  ...
                  <p className="text-gray-300 text-lg mb-6">
                    Start by connecting your Git repository or uploading your
                    project files. We support GitHub, GitLab, Bitbucket, and
                    direct file uploads.
                  </p>
            ...
            <div className="relative">
              <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
                <div className="lg:w-1/2">
                  ...
                  <p className="text-gray-300 text-lg mb-6">
                    Set up environment variables, choose your build settings,
                    and hit deploy. Our intelligent build system handles the
                    rest automatically.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center text-gray-400">
            ...
            <div className="relative">
              <div className="flex flex-col lg:flex-row items-center gap-12">
                <div className="lg:w-1/2">
                  ...
                  <p className="text-gray-300 text-lg mb-6">
                    Your site is deployed to our global CDN instantly. Get a
                    unique URL and custom domain support with automatic SSL
                    certificates.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center text-gray-400">
            ...
            <div className="relative">
              <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
                <div className="lg:w-1/2">
                  ...
                  <p className="text-gray-300 text-lg mb-6">
                    Track your site&apos;s performance with real-time analytics,
                    monitor deployments, and scale automatically as your traffic
                    grows.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center text-gray-400">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="glass-card group hover:neon-border transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-gray-400">
                    No complex configuration files or server management. Just
              ...
              <Card className="glass-card group hover:neon-border transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-gray-400">
                    Every branch gets its own preview URL for testing changes
                    before going live.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="glass-card group hover:neon-border transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-gray-400">
                    Track performance, uptime, and user analytics with our
          ...
          <div className="text-center bg-black/20 backdrop-blur-lg border border-white/10 rounded-2xl p-12">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Deploy your first site in under 5 minutes. No credit card required
              for our free tier.
            </p>
