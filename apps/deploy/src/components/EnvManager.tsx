    ...
    return variableEntries.map(([key, value]) =>
      editingKey === key ? (
        <TableRow key={key} className="bg-cyan-500/10 border-b-cyan-400/20">
          <TableCell className="font-medium align-middle text-cyan-300">
            {key}
          </TableCell>
          <TableCell>
            <Input
        ...
        <TableRow
          key={key}
          className="border-b-white/10 dark:odd:bg-white/5 hover:bg-cyan-400/5 group transition-colors duration-200"
        >
          ...
          <TableCell className="text-right">
            <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
              <Button
                ...
                className="hover:text-cyan-300 hover:bg-cyan-400/10"
              >
  ...
  return (
    <Card className="glass-card border-cyan-400/20 shadow-lg shadow-cyan-500/5">
      <CardHeader className="flex flex-row items-center justify-between pb-4">
        <CardTitle className="neon-etched-light text-2xl tracking-wider">
                ...
                <TableRow className="bg-cyan-500/10 border-b-cyan-400/20">
                  ...
                  <TableCell className="text-right">
                    <Button
                      ...
                      disabled={isUpdating || !newKey || !newValue}
                      className="bg-cyan-500 hover:bg-cyan-400 text-black font-bold transition-all duration-300 hover:shadow-[0_0_15px_-3px_rgba(0,255,255,0.8)] disabled:shadow-none"
                    >
                      Add
                    </Button>
                  </TableCell>
