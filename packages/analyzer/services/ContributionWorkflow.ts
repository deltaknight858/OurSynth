...
`;
    ...
    execSync('git add .');
    execSync(
      `git commit -m "feat(ui): add ${componentName} component via Self-Evolving Design System"`,
    );
    ...
    execSync(
      `gh pr create --title "Add ${componentName} component" --body "${prDescription}" --base main`,
    );
  }
}
