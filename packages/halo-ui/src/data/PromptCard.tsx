...
const variantAccent = {
  default: `border-[2px] border-[${neonPalette.plasma}]` +
    ' shadow-[0_0_16px_0_rgba(162,89,255,0.4)]',
  highlight: `border-[2px] border-[${neonPalette.neonGreen}]` +
    ' shadow-[0_0_16px_0_rgba(0,255,133,0.4)]',
  subtle: `border-[2px] border-[${neonPalette.neonYellow}]` +
    ' shadow-[0_0_16px_0_rgba(255,230,0,0.3)]',
};
    ...
    >
      {icon && (
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          transition={{ ...motionPresets.floatUp.transition, repeat: Infinity, repeatType: 'reverse', duration: 2 }}
        >
          {icon}
        </motion.div>
      )}
