...
const statusAccent = {
  online:
    'bg-neon-success text-neon-success border-neon-success shadow-[0_0_8px_0_theme(colors.neon.success/0.4)]',
  offline: 'bg-glass-border text-muted-foreground border-glass-border',
  error:
    'bg-neon-warning text-neon-warning border-neon-warning shadow-[0_0_8px_0_theme(colors.neon.warning/0.4)]',
  pending:
    'bg-neon-primary text-neon-primary border-neon-primary shadow-[0_0_8px_0_theme(colors.neon.primary/0.3)]',
...
export const StatusBadge = ({ label, status = 'custom', icon }: StatusBadgeProps) => {
  return (
    <motion.span
      className={clsx(
