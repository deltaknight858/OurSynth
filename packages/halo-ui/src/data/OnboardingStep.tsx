...
const statusAccent = {
  ...
  active:
    'border-neon-primary text-neon-primary shadow-[0_0_12px_0_theme(colors.neon.primary/0.3)]',
  complete:
    'border-neon-success text-neon-success shadow-[0_0_12px_0_theme(colors.neon.success/0.3)]',
};
