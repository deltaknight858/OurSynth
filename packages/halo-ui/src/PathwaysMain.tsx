...
const pathwaysResults = [
  {
    ...
    icon: <span role="img" aria-label="studio">🛠️</span>,
  },
  {
    key: 'pathways',
    title: 'Pathways Wizard',
    description: 'AI-powered scaffolding for your app.',
    icon: <span role="img" aria-label="pathways">✨</span>,
  },
          ...
          <div className="grid gap-6 mt-4">
            {results.map((r, i) => (
              <PromptCard
                ...
                action={<button className="btn btn-secondary" onClick={() => handleAddToStudio(r.key)}>Add to Studio</button>}
              />
            ))}
          </div>
        )}
