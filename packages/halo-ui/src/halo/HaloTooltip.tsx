// Migrated from apps/Halo-UI/src/components/halo/HaloTooltip.tsx
...
export default function HaloTooltip({
  ...
  const arrowClasses = {
    ...
    bottom:
      'bottom-full left-1/2 -translate-x-1/2 border-l-transparent border-r-transparent border-t-transparent border-b-[rgb(var(--halo-fg))]',
    ...
    right:
      'right-full top-1/2 -translate-y-1/2 border-t-transparent border-b-transparent border-l-transparent border-r-[rgb(var(--halo-fg))]',
  };
