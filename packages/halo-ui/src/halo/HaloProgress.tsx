// Migrated from apps/Halo-UI/src/components/halo/HaloProgress.tsx
...
export default function HaloProgress({
  ...
  return (
    <div className={cn("w-full bg-[rgba(var(--halo-fg),0.08)] rounded-full", sizeClasses[size], className)}>
      <div
        className={cn(
